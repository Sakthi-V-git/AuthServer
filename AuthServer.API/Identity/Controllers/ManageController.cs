...
using AuthServer.API.Identity.ViewModels;
using AuthServer.API.Services;
using AuthServer.API.Settings;
using Microsoft.Extensions.Options;
using AuthServer.API.Identity.Models;
using System.Collections.Generic;
using System;

namespace AuthServer.API.Identity.Controllers
{
